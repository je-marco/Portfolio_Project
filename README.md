...
- [X] Leveraged machine learning algorithms to predict the quality of white wines based on objective analytical test results.
...
**PREDICTING CHURN OF THE WAZE APP USERS**
- [X] Full analysis of the Waze app's user data to predict monthly user churn.
...
- [X] Built a model that can predict employees likely to quit at Salifort Motors (*a fictional company*) and identify factors that contribute to their leaving.
